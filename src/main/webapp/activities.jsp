                        ...
                        <div class="col-lg-8 mb-4 order-0" style="width: 100%;">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <span>Liste des activitées :</span>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <c:forEach var="activity" items="${activities}">
                                                <tr>
                                                    ...
                                                    <td>${activity.desc_buy}</td>

                                                    <td>${activity.desc_sell}</td>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <form action="/supprimer-activity" method="post">
                            ...
                            <form action="/createActivity.jsp" method="get">
                                <button class="btn btn-primary" type="submit">Créer Activity</button>
                            </form>
                        </div>
                    </div>
                </div>
