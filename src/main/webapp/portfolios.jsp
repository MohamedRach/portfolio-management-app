        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h2 class="card-title text-primary">All of your portfolios :</h2>
                    <div style="display: grid; grid-template-columns: repeat(4, 250px); column-gap: 30px; row-gap: 20px;">
                        ...
                        <div class="col">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title" style="text-align: center"><%= portfolio.getName() %></h5>
                                    ...
                                    <!-- Buttons -->
                                       ...
                                       <a href=<%= "/portfolio?id=" + portfolio.getId()%>> <button type="button" style="width: 100%" class="btn btn-primary">see portfolio</button><a>
                                </div>
